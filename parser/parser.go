...
import (
	...
	"github.com/albertofp/interpreter-go/ast"
	"github.com/albertofp/interpreter-go/lexer"
	"github.com/albertofp/interpreter-go/token"
)

const (
	_ int = iota // constants below this are assigned 1 to 7
	LOWEST
	EQUALS
	LESSGREATER
	SUM
